...
<div>
    ...
    <p style="font-size: 12px; color: #888; margin-top: 40px;">본 콘텐츠는 일반적인 정보를 제공하며, 실제 세무 신고 시에는 반드시 세무사 등 전문가의 개별 상담을 거치시기 바랍니다. 최종 업데이트: 2026-05-13</p>
</div>
    `,
    category: "대출-금융",
    author: "편집팀",
...
`,
  ...
  },
  {
    ...
    content: `
      ...
      <p class="text-xs text-gray-400 mt-6">최종 에디팅 발행일: 2026-06-14</p>
    `,
    category: "대출-금융",
    author: "편집팀",
    date: "2026-06-14",
