        ...
        try {
          ...
          const localData = {
            ...
            content: `
              ...
              <p>본 가이드는 주거 현장의 실제 규정과 공고를 바탕으로 정리한 실무 분석 자료입니다. 계약 및 대출 전 관계 기관의 최신 공식 공고문을 반드시 최종 대조하시기 바랍니다.</p>
            `,
            excerpt: `${topic}에 대한 핵심 실무 분석 가이드입니다.`,
            hashtags: ["부동산정책", "주택청약", "부동산실무", "하우징허브", "안심주거"],
            readTime: ""
          };
